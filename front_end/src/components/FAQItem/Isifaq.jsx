            ...
            <Container>
              ...
              <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      PTN adalah Perguruan Tinggi Negeri dan PTS adalah
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body d-flex justify-content-center">
                      ...
                      (BAN-PT), yaitu sebuah lembaga akreditasi indepeden yang
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      untuk mengetahui batas minimal yang harus dicapai dari
                      hasil SBMPTN untuk memilih jurusan di suatu universitas.
                    </div>
                  </div>
                </div>
                <div className="accordion-item">

            ...
            <Container>
              ...
              <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">PTN adalah Perguruan Tinggi Negeri dan PTS adalah Perguruan Tinggi Swasta.</div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h3 class="accordion-header" id="headingTwo">
                  ...
                  <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body d-flex justify-content-center">
                      ...
                      pendidikan. Akreditasi diselenggaakan oleh lembaga independen di luar dari universitas, untuk skala nasional biasanya dilakukan oleh Badan Akreditasi Nasional – Perguruan Tinggi (BAN-PT), yaitu sebuah lembaga
                      akreditasi indepeden yang menjadi rujukan nasional dan internasional.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">Passing Grade digunakan pada seleksi SBMPTN yang digunakan untuk mengetahui batas minimal yang harus dicapai dari hasil SBMPTN untuk memilih jurusan di suatu universitas.</div>
                  </div>
                </div>
                <div class="accordion-item">
